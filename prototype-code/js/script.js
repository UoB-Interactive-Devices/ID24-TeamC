document.addEventListener('DOMContentLoaded', function() {
    ...
    var currentIndex = 0;
    var images = ["school-of-athens.jpg","lady-jane-grey.jpg","bansky-test.jpg"]; 
    ...
    function generateHTML(data) {
        ...
        //banksy-test.jpg
        var originalWidth = 598;
        var originalHeight = 1063;
        ...
        data.forEach(function(row) {
            ...
            var markTopPercent = parseInt(row.marker_top) / originalHeight * imageHeight + imageOffsetTop;
            var markLeftPercent = parseInt(row.marker_left) / originalWidth * imageWidth + imageOffsetLeft;
            var markWidthPercent = parseInt(row.marker_width) / originalWidth * imageWidth;
            var markHeightPercent = parseInt(row.marker_height) / originalHeight * imageHeight;

            var infoTopPercent = parseInt(parseInt(row.info_top) / originalHeight * imageHeight);
            var infoLeftPercent = parseInt(parseInt(row.info_left) / originalWidth * imageWidth);
